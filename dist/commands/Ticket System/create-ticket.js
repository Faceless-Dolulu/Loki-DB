import { ChannelType, EmbedBuilder, InteractionContextType, PermissionFlagsBits, SlashCommandBuilder, } from "discord.js";
...
export const data = new SlashCommandBuilder()
    ...
    .setName("admin-only")
    .setDescription("Sets whether the ticket opened is only viewable to server Admins")
    .setRequired(true));
export async function run({ interaction, client, handler }) {
    try {
        ...
        const openingMessage = new EmbedBuilder()
            .setColor(0xc6d11a)
            .setDescription(`Thank you for opening a ticket. Please include all information relevant to this ticket (ex. evidence of rules being violated). \n \n A staff member will respond to your ticket at their earliest convenience.`);
